...
$router->post('/certificado/validar', [PublicController::class, 'verifyCertificate']);
...
$router->get('/curso/aula/{id}', [EducationController::class, 'publicLesson']);
$router->get('/curso/{id}', [EducationController::class, 'publicCourse']);
$router->post('/curso/{id}/inscricao', [EducationController::class, 'publicEnrollment']);
...
$router->get('/admin/education/certificate-administration', [EducationController::class, 'certificateAdministration']);
$router->get('/admin/education/certificate-report', [EducationController::class, 'certificateReport']);
