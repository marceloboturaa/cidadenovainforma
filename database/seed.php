...
$courseCertificateColumns = [
    ...
    'certificate_text_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_text_color VARCHAR(20) NULL AFTER certificate_font_family',
    'certificate_body_background_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_body_background_color VARCHAR(20) NULL AFTER certificate_text_color',
    'certificate_body_background_enabled' => 'ALTER TABLE education_courses ADD COLUMN certificate_body_background_enabled TINYINT(1) NOT NULL DEFAULT 0 AFTER certificate_body_background_color',
    'certificate_footer_text_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_text_color VARCHAR(20) NULL AFTER certificate_body_background_enabled',
    'certificate_footer_background_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_background_color VARCHAR(20) NULL AFTER certificate_footer_text_color',
    'certificate_footer_background_enabled' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_background_enabled TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_footer_background_color',
    'certificate_footer_rounded' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_rounded TINYINT(1) NOT NULL DEFAULT 0 AFTER certificate_footer_background_enabled',
    'certificate_background' => 'ALTER TABLE education_courses ADD COLUMN certificate_background VARCHAR(255) NULL AFTER certificate_footer_rounded',
    'certificate_ready_image' => 'ALTER TABLE education_courses ADD COLUMN certificate_ready_image VARCHAR(255) NULL AFTER certificate_background',
    'certificate_min_frequency' => 'ALTER TABLE education_courses ADD COLUMN certificate_min_frequency TINYINT UNSIGNED NOT NULL DEFAULT 0 AFTER certificate_ready_image',
    'certificate_show_heading' => 'ALTER TABLE education_courses ADD COLUMN certificate_show_heading TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_min_frequency',
    'certificate_show_text' => 'ALTER TABLE education_courses ADD COLUMN certificate_show_text TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_show_heading',
    'certificate_show_qr' => 'ALTER TABLE education_courses ADD COLUMN certificate_show_qr TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_show_text',
    'certificate_show_recipient' => 'ALTER TABLE education_courses ADD COLUMN certificate_show_recipient TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_show_qr',
    ...
    'certificate_footer_on_back' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_on_back TINYINT(1) NOT NULL DEFAULT 0',
    'certificate_hide_responsible' => 'ALTER TABLE education_courses ADD COLUMN certificate_hide_responsible TINYINT(1) NOT NULL DEFAULT 0',
    'certificate_program_background_enabled' => 'ALTER TABLE education_courses ADD COLUMN certificate_program_background_enabled TINYINT(1) NOT NULL DEFAULT 1',
    'certificate_program_text_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_program_text_color VARCHAR(20) NULL',
...
$columns = [
    'hide_summary_in_body' => "ALTER TABLE news ADD COLUMN hide_summary_in_body TINYINT(1) NOT NULL DEFAULT 0 AFTER summary",
    'cover_caption' => "ALTER TABLE news ADD COLUMN cover_caption VARCHAR(255) NULL AFTER cover_image",
    'cover_size' => "ALTER TABLE news ADD COLUMN cover_size VARCHAR(20) NOT NULL DEFAULT 'full' AFTER cover_caption",
    'hide_cover_in_body' => "ALTER TABLE news ADD COLUMN hide_cover_in_body TINYINT(1) NOT NULL DEFAULT 0 AFTER cover_caption",
    'co_author_name' => "ALTER TABLE news ADD COLUMN co_author_name VARCHAR(160) NULL AFTER hide_cover_in_body",
...
$roles = [
    ...
    ['DIRETOR', 'diretor', 50],
    ['EDITOR JORNALISTICO', 'editor-jornalistico', 45],
