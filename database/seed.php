...
$courseCertificateColumns = [
    ...
    'certificate_footer_text_color' => 'ALTER TABLE education_courses ADD COLUMN certificate_footer_text_color VARCHAR(20) NULL AFTER certificate_text_color',
    ...
    'certificate_background' => 'ALTER TABLE education_courses ADD COLUMN certificate_background VARCHAR(255) NULL AFTER certificate_footer_background_enabled',
