...
$courseCertificateColumns = [
    ...
    'certificate_show_recipient' => 'ALTER TABLE education_courses ADD COLUMN certificate_show_recipient TINYINT(1) NOT NULL DEFAULT 1 AFTER certificate_show_heading',
