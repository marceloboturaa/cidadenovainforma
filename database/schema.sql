...
CREATE TABLE IF NOT EXISTS library_event_participants (
    ...
    registration_extra_answer TEXT NULL,
    created_by BIGINT UNSIGNED NULL,
    created_at TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS news (
    ...
    summary TEXT NULL,
    hide_summary_in_body TINYINT(1) NOT NULL DEFAULT 0,
    content LONGTEXT NOT NULL,
    cover_image VARCHAR(255) NULL,
    cover_caption VARCHAR(255) NULL,
    cover_size VARCHAR(20) NOT NULL DEFAULT 'full',
    hide_cover_in_body TINYINT(1) NOT NULL DEFAULT 0,
    co_author_name VARCHAR(160) NULL,
