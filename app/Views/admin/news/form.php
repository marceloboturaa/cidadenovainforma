...
<form method="post" action="<?= e($action) ?>" enctype="multipart/form-data" class="editor-grid">
    ...
    <section class="panel editor-main">
        ...
        <div class="editor-section">
            ...
            <p class="field-hint">Use a barra do editor para inserir imagens, videos, links, tabelas, codigo e espacamento. Para formulas, escreva \(a^2+b^2=c^2\) no texto ou $$E=mc^2$$ em uma linha separada.</p>
        </div>
    </section>
